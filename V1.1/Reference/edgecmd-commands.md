...
### (DE) Buffering facet configuration
...
### (DE) Health endpoints facet configuration
...
## (DE) OMF egress data endpoints facet configuration
...
### (DE) Logging facet configuration
...
### (DE) Schedules facet configuration
...
### (DE) Data filters facet configuration
...
### (DE) Data source facet configuration
...
### (DE) Data selection facet configuration
...
### (DE) General facet configuration
...
## (DE) EDS configuration

### (DE) Storage configuration
