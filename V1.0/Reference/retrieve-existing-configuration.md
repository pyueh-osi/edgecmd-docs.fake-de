...
## (DE) View all components configuration
...
#### (DE) View the configuration of the System component
...
#### (DE) View the configuration of the Logging facet within the Storage component
...
#### (DE) View the configuration of a specific entry in the PeriodicEgressEndpoint facet within the Storage component
